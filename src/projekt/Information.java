...
public class Information extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 104, 247));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 26)); // NOI18N
        jLabel1.setText("Informacje");
...
private void table_update1()
{
    ...
    try {
        ...
        DefaultTableModel Dk = (DefaultTableModel)jTable1.getModel();
                ...
                for (int a=1; a<=c; a++)
                {
                t1.add(rs.getString("Kurs"));
                t1.add(rs.getString("Tresc"));
                t1.add(rs.getString("Wystawil"));
                t1.add(rs.getString("Data"));
                }
                Dk.addRow(t1);
                }
